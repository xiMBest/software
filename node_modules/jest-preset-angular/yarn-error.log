Arguments: 
  /home/wtho/.nvm/versions/node/v12.5.0/bin/node /home/wtho/.nvm/versions/node/v12.5.0/bin/yarn add jest-preset-angular@file:../ -D --force --ignore-optional

PATH: 
  /home/wtho/.nvm/versions/node/v12.5.0/bin:/home/wtho/bin:/usr/local/sbin:/usr/local/bin:/usr/bin:/usr/lib/jvm/default/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl:/opt/apache-spark/bin:/home/wtho/.gem/ruby/2.6.0/bin
...
Trace: 
  Error: EACCES: permission denied, scandir '/home/wtho/workspace/solarized/storage/mongo-data/diagnostic.data'
...
npm manifest: 
  {
    ...
    "scripts": {
      "build": "tsc; cp src/*.js build; cp src/jest-preset.js .",
      "prepare": "yarn build",
      "test": "jest",
      "test:ci": "jest -i"
    }
...
Lockfile: 
  ...
  cssstyle@^1.1.1:
    version "1.2.0"
    resolved "https://registry.yarnpkg.com/cssstyle/-/cssstyle-1.2.0.tgz#fc1e4df631374b4a3f12a1fc8278217d5a718ec5"
    integrity sha512-CYz0dquY+OlKR9ueeUsB94aXWEopcvnTLVt7efxKAG3wWOEWwLYrI183/VEGSsns7ZUjDCEoqJcbVe9xcp6ldA==
    dependencies:
      cssom "0.3.x"
  ...
  jest-environment-jsdom-thirteen@^1.0.0:
    version "1.0.0"
    resolved "https://registry.yarnpkg.com/jest-environment-jsdom-thirteen/-/jest-environment-jsdom-thirteen-1.0.0.tgz#24eac0718c5792edef269232b5bac3cf82b18911"
    integrity sha512-DOlBE/tUgb8okcOcehf8Yt5U9o/QlkLoGS9HwKZtzKiKrntyCAb12FTmuBfEpjZXsA/p559Kuw0PbSh5GzEcjw==
    dependencies:
      jest-mock "^24.0.0"
      jest-util "^24.0.0"
      jsdom "^13.0.0"
